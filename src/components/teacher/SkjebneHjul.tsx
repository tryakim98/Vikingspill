      ...
      <div className="relative" style={{ width: SIZE, height: SIZE, maxWidth: '100%' }}>
        ...
        >
          ...
          {WHEEL_FIELDS.map((f, i) => (
            <path key={f.id} d={sectorPath(i)} fill={f.color} stroke="#D4A843" strokeWidth="3" />
          ))}
        ...
        >
          <svg width="56" height="64" viewBox="0 0 56 64">
            <polygon points="28,62 6,4 50,4" fill="#D4A843" stroke="#3a1f0d" strokeWidth="3" />
