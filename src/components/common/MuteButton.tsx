...
export default function MuteButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 z-[70] flex h-12 w-12 items-center justify-center rounded-full border-2 border-viking-gold/70 bg-viking-surface text-2xl transition-colors hover:border-viking-gold hover:bg-viking-surface"
    >
      {muted ? '🔇' : '🔊'}
    </button>
  );
