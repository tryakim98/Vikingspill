...
export const fateCards: FateCard[] = [
  ...
  {
    id: 'gissel', icon: '⛓', title: 'Tatt som gissel',
  ...
  {
    id: 'munk-uten-tolk', icon: '🏛', title: 'Munk uten tolk',
