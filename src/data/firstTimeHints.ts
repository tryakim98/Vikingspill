...
export const HINTS: Record<HintKey, Hint> = {
  ...
  'locked-system': {
    ...
    body: 'Sidesteder krever at dere har gjort dere fortjent: bestått et ferdsbrev, samlet handelsvarer, bygget rykte eller hevet en ferdighet. Det dere prioriterer underveis bestemmer hvor dere kan reise. Sjekk «Krever»-boksen på det låste stedet for å se hvilke veier som er åpne.',
  },
};
