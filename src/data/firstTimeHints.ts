...
export const HINTS: Record<HintKey, Hint> = {
  ...
  'reward-skill': {
    ...
    body: 'Ferdigheter (språk, sjømannskap, krigskunst, diplomati, tro) gir bonus på terningkast og åpner spesifikke valg. På nivå 1 og 2 kan dere ta en verdighetsprøve for å stige.',
  },
  'reward-goods': {
    icon: '📦',
